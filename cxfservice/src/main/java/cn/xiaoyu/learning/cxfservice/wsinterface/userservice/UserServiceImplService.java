 ...
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://impl.service.cxfservice.learning.xiaoyu.cn/", wsdlLocation = "http://localhost:8080/cxfservice/webService/userservice?wsdl")
public class UserServiceImplService
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.cxfservice.learning.xiaoyu.cn/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/cxfservice/webService/userservice?wsdl");
    ...
    /**
     * @return returns IUserService
     */
    @WebEndpoint(name = "UserServiceImplPort")
    public IUserService getUserServiceImplPort() {
        return super.getPort(new QName("http://impl.service.cxfservice.learning.xiaoyu.cn/", "UserServiceImplPort"), IUserService.class);
    }
    ...
    public IUserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.cxfservice.learning.xiaoyu.cn/", "UserServiceImplPort"), IUserService.class, features);
    }
